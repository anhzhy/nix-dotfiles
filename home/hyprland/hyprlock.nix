    ...
    settings = {
      ...
      shape = [
        {
          ...
          position = "0, ${if device == "laptop" then "120" else "270"}";
          halign = "center";
          valign = "bottom";
        }
      ];
      ...
      label = [
        # Time
        {
          ...
          shadow_passes = 3;
          position = "0, ${if device == "laptop" then "-25" else "-150"}";
          halign = "center";
          valign = "top";
        }
        # Date
        {
          ...
          shadow_passes = 3;
          position = "0, ${if device == "laptop" then "-225" else "-350"}";
          halign = "center";
          valign = "top";
        }
        # Username
        {
          ...
          font_size = 15;
          font_family = "Maple Mono Bold";
          position = "0, ${if device == "laptop" then "131" else "281"}";
          halign = "center";
          valign = "bottom";
        }
      ];
      ...
      input-field = [
        {
          ...
          hide_input = false;
          position = "0, ${if device == "laptop" then "50" else "200"}";
          halign = "center";
          valign = "bottom";
        }
      ];
